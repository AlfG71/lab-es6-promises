...
async function makeBrusselsSprouts(){
  ...
  try {
    ...
    let step8 = document.querySelector("#brusselsSproutsImg");

    let results = await Promise.all([step0,
      step1,
      step2,
      step3,
      step4,
      ...
      step6,
      step7,
     ]) //argument for Promise.all method is an array of promises
